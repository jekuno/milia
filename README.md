...
### news flash: milia v1.0.0-beta-6 for rails 4.0/devise 3.2 now available

Find it and the drastically revised README, as well as a complete
step-by-step tutorial on getting an app working with milia at the "v1.0.0-beta-6" branch.
...
### the following README applies only to v0.3.x milia for Rails 3.2.x/Devise 2.1.x
